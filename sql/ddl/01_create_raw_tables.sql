...
CREATE OR REPLACE TABLE RAW_BRANCHES (
    ...
    CONSTRAINT PK_RAW_BRANCHES
        PRIMARY KEY (BRANCH_ID),

    CONSTRAINT UQ_RAW_BRANCHES_CODE
        UNIQUE (BRANCH_CODE)
)
...
CREATE OR REPLACE TABLE RAW_PRODUCTS (
    ...
    CONSTRAINT UQ_RAW_PRODUCTS_CODE
        UNIQUE (PRODUCT_CODE)
)
...
CREATE OR REPLACE TABLE RAW_CUSTOMERS (
    ...
    CONSTRAINT UQ_RAW_CUSTOMERS_NUMBER
        UNIQUE (CUSTOMER_NUMBER),

    CONSTRAINT FK_RAW_CUSTOMERS_BRANCH
        FOREIGN KEY (PRIMARY_BRANCH_ID)
        REFERENCES RAW_BRANCHES (BRANCH_ID)
)
...
CREATE OR REPLACE TABLE RAW_ACCOUNTS (
    ...
    CONSTRAINT PK_RAW_ACCOUNTS
        PRIMARY KEY (ACCOUNT_ID),

    CONSTRAINT UQ_RAW_ACCOUNTS_NUMBER
        UNIQUE (ACCOUNT_NUMBER),

    CONSTRAINT FK_RAW_ACCOUNTS_PRODUCT
        FOREIGN KEY (PRODUCT_ID)
        REFERENCES RAW_PRODUCTS (PRODUCT_ID),

    CONSTRAINT FK_RAW_ACCOUNTS_BRANCH
...
CREATE OR REPLACE TABLE RAW_CUSTOMER_ACCOUNT_RELATIONSHIPS (
    ...
    CONSTRAINT PK_RAW_CUSTOMER_ACCOUNT_RELATIONSHIPS
        PRIMARY KEY (RELATIONSHIP_ID),

    CONSTRAINT FK_RAW_CAR_CUSTOMER
        FOREIGN KEY (CUSTOMER_ID)
        REFERENCES RAW_CUSTOMERS (CUSTOMER_ID),

    CONSTRAINT FK_RAW_CAR_ACCOUNT
...
CREATE OR REPLACE TABLE RAW_ACCOUNT_TRANSACTIONS (
    ...
    CONSTRAINT PK_RAW_ACCOUNT_TRANSACTIONS
        PRIMARY KEY (TRANSACTION_ID),

    CONSTRAINT FK_RAW_TRANSACTIONS_ACCOUNT
        FOREIGN KEY (ACCOUNT_ID)
        REFERENCES RAW_ACCOUNTS (ACCOUNT_ID),

    CONSTRAINT FK_RAW_TRANSACTIONS_BRANCH
        FOREIGN KEY (BRANCH_ID)
        REFERENCES RAW_BRANCHES (BRANCH_ID)
)
...
CREATE OR REPLACE TABLE RAW_LOANS (
    ...
    CONSTRAINT PK_RAW_LOANS
        PRIMARY KEY (LOAN_ID),

    CONSTRAINT UQ_RAW_LOANS_NUMBER
        UNIQUE (LOAN_NUMBER),

    CONSTRAINT FK_RAW_LOANS_CUSTOMER
        FOREIGN KEY (CUSTOMER_ID)
        REFERENCES RAW_CUSTOMERS (CUSTOMER_ID),

    CONSTRAINT FK_RAW_LOANS_PRODUCT
        FOREIGN KEY (PRODUCT_ID)
        REFERENCES RAW_PRODUCTS (PRODUCT_ID),

    CONSTRAINT FK_RAW_LOANS_BRANCH
        FOREIGN KEY (BRANCH_ID)
        REFERENCES RAW_BRANCHES (BRANCH_ID)
)
...
CREATE OR REPLACE TABLE RAW_LOAN_PAYMENTS (
    ...
    CONSTRAINT PK_RAW_LOAN_PAYMENTS
        PRIMARY KEY (LOAN_PAYMENT_ID),

    CONSTRAINT FK_RAW_LOAN_PAYMENTS_LOAN
        FOREIGN KEY (LOAN_ID)
        REFERENCES RAW_LOANS (LOAN_ID)
)
